...
--    Pink        ESC
--    Steel_Blue  inactive modifier keys (SHIFT, ALT, CAPS, F-keys)
...
procedure Keyboard_Widget_2 is
   ...
   begin
      ...
      Add_Key (Descs, "LALT",  6, Color_Inactive);
      Add_Key (Descs, "SPACE", 22);
      Add_Key (Descs, "RALT",  6, Color_Inactive);
...
begin
   ...
   while Running loop
      ...
      loop
         ...
         --  Only ESC quits; Ctrl+C maps to Modifier=Ctrl, Cmd=None.
